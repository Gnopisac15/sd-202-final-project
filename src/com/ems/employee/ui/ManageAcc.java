...
//        String temp_pwd = String.valueOf(pwd.getPassword());
        String edit_cpwd = String.valueOf(cpwd.getPassword());
        String edit_pwd = String.valueOf(pwd.getPassword());
        if (edit_cpwd.equals(edit_pwd)) {
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sd-202", "root", "");
                Statement stmt = con.createStatement();
                stmt.execute("UPDATE employee SET email='" + userEmail.getText() + "',password='" +edit_pwd + "',firstName='" + fname.getText() + "',lastName='" + lName.getText() + "',department='" + dpmt.getText() + "',position='" + pos.getText() + "' WHERE emp_id='" + emp_ID + "'");
